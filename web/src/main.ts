...
const downloadPath = `/downloads/Pilgrim-of-the-Thorn-macOS-v${__PILGRIM_VERSION__}.dmg`;
...
app.innerHTML = `
  <header class="site-header" aria-label="Primary">
    <a class="brand-mark" href="#top" aria-label="Pilgrim of the Thorn home">
  ...
  <main id="top">
    <section class="hero" id="download" aria-labelledby="hero-title">
      ...
      <div class="hero-content">
        ...
        <div class="hero-actions" aria-label="Download actions">
          <a class="download-button" href="${downloadPath}" download>
            Download for Mac
          </a>
          <a class="secondary-button" href="#world">Enter the abbey</a>
        </div>
        <p class="download-note">macOS DMG version ${__PILGRIM_VERSION__}</p>
      </div>
    </section>
    ...
    <section class="final-call" aria-labelledby="final-title">
      <div>
        ...
        <p>Download the current Mac build and step into the first playable proof of concept.</p>
      </div>
      <a class="download-button" href="/api/download">Download DMG</a>
    </section>
  </main>
`;
