/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.env.example --strict-vars=false` (hash: 81f0e8839f587a07730b2163badb603d)
// Runtime types generated with workerd@1.20260623.1 2026-06-23 nodejs_compat
interface __BaseEnv_Env {
	GAME_DOWNLOADS: R2Bucket;
	DB: D1Database;
	EMAIL: SendEmail;
	GAME_PRICE_CENTS: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GAME_PRICE_CENTS" | "GAME_CURRENCY" | "PUBLIC_SITE_URL" | "EMAIL_FROM" | "SUPPORT_EMAIL" | "STRIPE_SECRET_KEY" | "STRIPE_WEBHOOK_SECRET">> {}
}
